...
namespace AuthService.Services
{
    public class TokenCleanupService : BackgroundService
    {
        ...
        private async Task CleanupExpiredTokensAsync()
        {
            ...
            var magicLinkTokenRepository = scope.ServiceProvider.GetRequiredService<IMagicLinkTokenRepository>();
            ...
            try
            {
                ...
                await magicLinkTokenRepository.DeleteExpiredTokensAsync();
                
                _logger.LogInformation("Expired tokens cleanup completed successfully");
            }
            catch (Exception ex)
            {
