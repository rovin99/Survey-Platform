...
export const API_CONFIG = {
  ...
  // Kourier routing hosts (required for proper routing in Kubernetes)
  hosts: {
    auth: 'auth-service.default.127.0.0.1.nip.io',
    survey: 'survey-management-service.default.127.0.0.1.nip.io',
    participants: 'participants-management-service.default.127.0.0.1.nip.io',
  },
  ...
  endpoints: {
    ...
    survey: {
      ...
      host: 'survey-management-service.default.127.0.0.1.nip.io',
      paths: {
        surveys: '/api/surveys',
    ...
    participants: {
      ...
      host: 'participants-management-service.default.127.0.0.1.nip.io',
      paths: {
